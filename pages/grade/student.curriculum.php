...
<head>
    ...
    <title>Student's Curriculum | BED OnGrade - Laspinas</title>
                            ...
                            <div class="card">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if ($_POST['submit'] != "empty") {
                                        header("location: ../forms/student.data.curriculum.php?student_id=".$student_id);

                                    } else {
                                        header("location: ../forms/student.empty.curriculum.php?student_id=".$student_id);
